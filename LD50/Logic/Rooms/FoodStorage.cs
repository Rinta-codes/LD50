...
namespace LD50.Logic.Rooms
{
    public class FoodStorage : Room
    {
        ...
        public FoodStorage(Vector2 onCarPosition, int capacity) : base(new Sprite(TexName.ROOM_FOODSTORAGE, Vector2.Zero, new Vector2(300, 150), Graphics.DrawLayer.ROOMS, false), onCarPosition, $"Food Storage: Can store {capacity} food.")
        {
            Capacity = capacity;
