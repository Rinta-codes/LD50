...
namespace LD50.UI
{
    public class DebugUI : UIElements
    {
        public DebugUI()
        {
            ...
            newAmbush.OnClickAction = () => { Globals.scenes[(int)Scenes.Scenes.EVENT] = new Ambush(false); Globals.currentScene = (int)Scenes.Scenes.EVENT; Globals.hud.ToggleButtons(); };
            ...
            newBPTrade.OnClickAction = () => { Globals.scenes[(int)Scenes.Scenes.EVENT] = new BlueprintTradeEvent(); Globals.currentScene = (int)Scenes.Scenes.EVENT; Globals.hud.ToggleButtons(); };
            ...
            newFoodPile.OnClickAction = () => { Globals.scenes[(int)Scenes.Scenes.EVENT] = new FoodPile(); Globals.currentScene = (int)Scenes.Scenes.EVENT; Globals.hud.ToggleButtons(); };
            ...
            newFuelPile.OnClickAction = () => { Globals.scenes[(int)Scenes.Scenes.EVENT] = new FuelPile(); Globals.currentScene = (int)Scenes.Scenes.EVENT; Globals.hud.ToggleButtons(); };
            ...
            newPersonEvent.OnClickAction = () => { Globals.scenes[(int)Scenes.Scenes.EVENT] = new PersonEvent(); Globals.currentScene = (int)Scenes.Scenes.EVENT; Globals.hud.ToggleButtons(); };
            ...
            newTradeEvent.OnClickAction = () => { Globals.scenes[(int)Scenes.Scenes.EVENT] = new TradeEvent(); Globals.currentScene = (int)Scenes.Scenes.EVENT; Globals.hud.ToggleButtons(); };
